        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
            ...
            <?php
				...
				foreach ($profiles as $p) {
                    $a = Profile::getAuthInfo($p['id']);
                    $TotalPosts = Profile::getTotalPostcount($p['owner']);
                    $TotalLikes = Profile::getTotalLikecount($p['owner']);
			?>
            
            <div class="col list-item" id="pro-<?=$p['id']?>">
                <div class="card-style">
                    <div class="box card-style">
                        <div class="user-activity text d-flex position-relative">
                            <div class="d-flex align-items-center flex-column">Posts<b><?=$TotalPosts['image_uri']?></b></div>
                            <?php
                                if ($TotalLikes['like_count'] !== null) {
                            ?>
                            <div class="d-flex align-items-center flex-column ms-4">Likes<b><?=$TotalLikes['like_count']?></b></div>
                            <?php
                                } else {
                            ?>
                            <div class="d-flex align-items-center flex-column ms-4">Likes<b>0</b></div>
                            <?php
                                }
                            ?>
                        </div>
                        ...
                        <div class="left_container off" id="<?=$p['id']?>-down">
                            ...
                            <div>
                                <h5 class="text text mb-3 mt-5">Contacts</h5>
                                <a href="#" class="text d-flex align-items-center my-2">
                                    ...
                                    <p class="contact-info m-0 ms-3">+91 <?=$a['phone']?></p>
                                </a>
                                <a href="#" class="text d-flex align-items-center">
                                    ...
                                    <p class="contact-info m-0 ms-3"><?=$a['email']?></p>
                                </a>
                            </div>
                            <div class="cancel card-style" id="<?=$p['id']?>">
                                <svg xmlns="http://www.w3.org/2000/svg" width="33" height="33" fill="currentColor" class="bi bi-arrow-left-short" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd" d="M12 8a.5.5 0 0 1-.5.5H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5a.5.5 0 0 1 .5.5z"/>
                                </svg>
                            </div>
            ...
            <h5 class="text d-flex align-items-center justify-content-center">No Results</h5>
