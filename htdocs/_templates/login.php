        ...
        <div class="login-form">      
			<form method="post" action="index">
				<div class="login-form-inner">
                    ...
                    <div class="register-div" style="display: flex; align-items: center; justify-content: center;">Don't Have Account? <a href="signup.php" class="link create-account">Create Account</a></div>
                </div>
            </form>
        </div>
    </div>
