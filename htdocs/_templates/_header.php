                        ...
                        <ul class="menu-links p-0 m-0 d-flex position-fixed justify-content-around">
                            ...
                            <li class="nav-link d-none align-items-center dropup position-fixed">
                                <a type="button" class="dropdown-toggle w-100 h-100 d-flex align-items-center text-decoration-none" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <span class="hidden-texts d-none text">More</span>
                                </a>
                                
                                <ul class="bottom-content dropdown-menu p-2" style="width: 14.2rem; left: -11rem;">
                                    
                                    <li class="mode position-relative d-flex align-items-center me-0">
                                        <div class="sun-moon">
                                            <i class='icon mt-1 position-absolute d-flex align-items-center justify-content-center moon'>
                                            ...
                                            <i class='icon d-flex align-items-center justify-content-center sun'>
                                        ...
                                        <span class="mode-text text" for="darkSwitch">Light & Dark</span>
                                    ...
                                    <li class="mode position-relative my-1 me-0">
                                        <a href="#" class="w-100 h-100 d-flex align-items-center text-decoration-none">
                                            <i class='icon d-flex align-items-center justify-content-center'>
                                    ...
                                    <hr class="m-0"><li class="mode position-relative mt-1 me-0">
                                        <a href="/?logout" class="w-100 h-100 d-flex align-items-center text-decoration-none">
                                            <i class='icon d-flex align-items-center justify-content-center'>
